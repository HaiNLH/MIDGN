...
class MIDGN(Model):
    ...
    def propagate(self):
        ...
        #------------------BI-------------------#
       # #------------------BI-------------------#
        # atom_bundles_feature, atom_item_feature = self.light_propagate(self.bi_norm_graph, self.bundles_feature, self.items_feature)	        # atom_bundles_feature, atom_item_feature = self.light_propagate(self.bi_norm_graph, self.bundles_feature, self.items_feature)


        # #------------------UI-------------------#	        # #------------------UI-------------------#
        # atom_user_feature, atom_item_feature2 = self.light_propagate(self.ui_norm_graph, self.users_feature, self.items_feature)	        # atom_user_feature, atom_item_feature2 = self.light_propagate(self.ui_norm_graph, self.users_feature, self.items_feature)
